...
curl ${baseurlMETARRAWL} | grep "<a href=" | sed -e "s/<img src=\"\/icons\/text.gif\" alt=\"\[TXT\]\"> //g" |sed -e "s/<a href=\"//g" |sed -e "s/\"$//g" |sed -e "s/\".*//g" | sed "s/^/`echo $sedURL`/"  |tee /tmp/REDBOOK-MOTHERLODE.txt
